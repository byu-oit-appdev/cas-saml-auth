...
public class GoogleResolver implements CredentialsToPrincipalResolver, InitializingBean {

    private static final Logger LOG = Logger.getLogger(GoogleResolver.class);
    ...
    public Principal resolvePrincipal(Credentials credentials) {
        ...
        final GoogleCredentials googleCredentials = (GoogleCredentials) credentials;

        final String principalId2 = googleCredentials.getUserID()+"#GOOGLE_ID";
